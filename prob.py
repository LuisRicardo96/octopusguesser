...
txt_mid_blue_champion_kda.close()
txt_mid_blue_champion_kda_r = open("mid_blue_champion_kda.txt", "r")
txt_mid_blue_champion_kda_r_text = txt_mid_blue_champion_kda.read()
...
txt_mid_blue_champion_ward.write(top_blue_champion_ward.text.text)
txt_mid_blue_champion_ward.close()
txt_mid_blue_champion_ward_r = open("txt_mid_blue_champion_ward", "r")
txt_mid_blue_champion_ward_r_text = txt_mid_blue_champion_ward.read()
